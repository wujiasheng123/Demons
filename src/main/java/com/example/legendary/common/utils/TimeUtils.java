...
public class TimeUtils {
	 ...
	 *            秒
	 */
	private TimeUtils(int day, int hour, int minute, int second) {
	 ...
	 *            分隔符字符串
	 */
	private void setTimeSeparator(String timeSeparator) {
	...
	private void parseTimeException(String time) {
		throw new IllegalArgumentException(time + ", time format error, HH" + this.timeSeparator + "mm"
				+ this.timeSeparator + "ss");
	}
