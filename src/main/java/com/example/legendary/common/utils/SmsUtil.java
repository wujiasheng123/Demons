...
public class SmsUtil {
     ...
     */
    private static final String ACCESS_KEY_ID = "LTAIaEpZ7g3rHGzb";

    /**
     * 此处需要替换成开发者自己的AK(在阿里云访问控制台寻找)
     */
    private static final String ACCESS_KEY_SECRET = "YN5FduIgs4lKZuA4J2OjJ6Q0bfVyw5";
    ...
    public static SendSmsResponse sendSms(String phone, String signature, String model, Map<String,String> modelMap, String outId) throws ClientException {
        ...
        for(String key : keys) {
            request.setTemplateParam("{\"" + key + "\":\"" + modelMap.get(key) + "\"}");
        }
     ...
     **/
    public static String randomCode(int sum){
    ...
    /*public static void main(String[] args) throws ClientException, InterruptedException {
        ...
        //发短信    (String phone, String signature, String model, Map<String,String> modelMap, String outId)
